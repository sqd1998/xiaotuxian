<script setup>
import { useSubCategory } from "./composables/useSubCategoryDate";
...
const { goodList, getGoodList, reqData } = useGoodList();
...
<template>
  <div class="container">
    ...
    <div class="sub-container">
      ...
      >
        <!-- 商品列表-->
        <GoodsItem :goods="goods" v-for="goods in goodList" :key="goods.id" />
      </div>
    </div>
  </div>
</template>
